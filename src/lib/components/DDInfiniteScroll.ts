...
import DDScroller from 'dd-scroller';
import { isPromise, toNumber, error } from '../utils';

let scroller: DDScroller = null as any;
...
export default class DDInfiniteScroll extends Vue {
  ...
  private start() {
    this.scroller.on('scroll', this.scrollTick, { tag: this, immediate: true });
  }
